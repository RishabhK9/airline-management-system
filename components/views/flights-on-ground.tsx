...
export function FlightsOnGround() {
  ...
  const fetchData = async () => {
    setLoading(true)
    const response = await executeView("flights_on_the_ground")
    ...
    <Card>
      <CardContent className="pt-6">
        ...
        {loading ? (
          ...
          <div className="text-center py-4 text-foreground/70">No flights currently on the ground</div>
        ) : (
